...
// --- T-002: GenericTargetProfile ---
export const genericTargetProfileSchema = z
  .object({
...
export type GenericTargetProfile = z.infer<typeof genericTargetProfileSchema>;

// --- T-003: GenericAuthorizationScope ---
export const genericAuthorizationScopeSchema = z
  .object({
...
export type GenericAuthorizationScope = z.infer<typeof genericAuthorizationScopeSchema>;

// --- T-004: GenericWorkflowPhase + GenericWorkflowRun ---
export const genericWorkflowPhaseSchema = z.object({
  phase: z.enum([
    "intake",
    "passive-scan",
    "hypothesis",
...
export type GenericWorkflowPhase = z.infer<typeof genericWorkflowPhaseSchema>;

export const genericWorkflowRunSchema = z
  .object({
    ...
    currentPhase: genericWorkflowPhaseSchema.shape.phase.optional(),
    phases: z.array(genericWorkflowPhaseSchema).optional(),
  })
  .superRefine((val, ctx) => {
...
export type GenericWorkflowRun = z.infer<typeof genericWorkflowRunSchema>;

// --- T-005: GenericAdminExposureEntry + GenericScanError + GenericPassiveScanEvidence ---
export const genericAdminExposureEntrySchema = z.object({
  path: z.string().startsWith("/"),
  method: z.enum(["HEAD", "GET"]).optional(),
  reachable: z.boolean(),
  httpStatus: z.number().int().min(100).max(599).optional(),
...
export type GenericAdminExposureEntry = z.infer<typeof genericAdminExposureEntrySchema>;

export const genericScanErrorSchema = z.object({
  stage: z.enum(["http", "tls", "cms", "admin-exposure"]),
  message: nonEmptyStringSchema,
});
export type GenericScanError = z.infer<typeof genericScanErrorSchema>;

export const genericPassiveScanEvidenceSchema = z
  .object({
    ...
    cms: z
      ...
      .optional(),
    adminExposure: z.array(genericAdminExposureEntrySchema).optional(),
    errors: z.array(genericScanErrorSchema).optional(),
...
export type GenericPassiveScanEvidence = z.infer<typeof genericPassiveScanEvidenceSchema>;

// --- T-006: GenericTechnologyFingerprint ---
export const genericTechnologyFingerprintSchema = z
  .object({
...
export type GenericTechnologyFingerprint = z.infer<
  typeof genericTechnologyFingerprintSchema
>;

// --- T-007: GenericVulnerabilityHypothesis ---
export const genericVulnerabilityHypothesisSchema = z
  .object({
...
export type GenericVulnerabilityHypothesis = z.infer<
  typeof genericVulnerabilityHypothesisSchema
>;

// --- T-008: TestStep + GenericTestPlan ---
...
export const genericTestPlanSchema = z
  .object({
...
export type GenericTestPlan = z.infer<typeof genericTestPlanSchema>;

// --- T-009: GenericApprovalGate ---
export const genericApprovalGateSchema = z
  .object({
...
export type GenericApprovalGate = z.infer<typeof genericApprovalGateSchema>;

// --- T-010: GenericFinding (declared before GenericValidationResult for z.lazy) ---
export const genericFindingSchema = z
  .object({
...
export type GenericFinding = z.infer<typeof genericFindingSchema>;

// --- T-011: GenericValidationResult ---
export const genericValidationResultSchema = z
  .object({
    ...
    findings: z.array(z.lazy(() => genericFindingSchema)).optional(),
  ...
  .superRefine((val, ctx) => {
    if (val.status === "failed" && (!val.findings || val.findings.length === 0)) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        message: "at least one GenericFinding required when status is failed",
        path: ["findings"],
      });
    }
    if (
...
export type GenericValidationResult = z.infer<typeof genericValidationResultSchema>;

// --- T-012: GenericAuditEvent (must be declared before GenericEvidenceEnvelope) ---
export const genericAuditEventSchema = z.object({
...
export type GenericAuditEvent = z.infer<typeof genericAuditEventSchema>;

// --- T-013: GenericReportArtifact ---
export const genericReportArtifactSchema = z
  .object({
...
export type GenericReportArtifact = z.infer<typeof genericReportArtifactSchema>;

// --- T-014: GenericEvidenceEnvelope (discriminated union) ---
export const passiveScanPayloadSchema = genericPassiveScanEvidenceSchema;
export const fingerprintPayloadSchema = genericTechnologyFingerprintSchema;
export const hypothesisPayloadSchema = genericVulnerabilityHypothesisSchema;
export const testResultPayloadSchema = genericValidationResultSchema;
export const auditPayloadSchema = genericAuditEventSchema;
export const otherPayloadSchema = z.record(z.string(), z.unknown());

export const genericEvidenceEnvelopeSchema = z.discriminatedUnion("payloadType", [
  z.object({
...
export type GenericEvidenceEnvelope = z.infer<typeof genericEvidenceEnvelopeSchema>;
