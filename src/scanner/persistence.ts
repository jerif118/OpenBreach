...
export type RawScanPersistenceResult = Omit<RawScanEvidence, "municipalityId"> & {
...
export function toRawScanPersistenceArgs(results: readonly RawScanEvidence[]): RawScanPersistenceArgs {
  return {
