...
export type EnrichedScanPersistenceResult = Omit<ScanResult, "municipalityId"> & {
...
export function toEnrichedScanPersistenceArgs(results: readonly ScanResult[]): EnrichedScanPersistenceArgs {
  return {
